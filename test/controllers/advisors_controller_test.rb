...
class AdvisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advisor" do
    assert_difference('Advisor.count') do
      post advisors_url, params: { advisor: { date: @advisor.date, end_time: @advisor.end_time, name: @advisor.name, start_time: @advisor.start_time } }
    end
  ...
  test "should update advisor" do
    patch advisor_url(@advisor), params: { advisor: { date: @advisor.date, end_time: @advisor.end_time, name: @advisor.name, start_time: @advisor.start_time } }
